...
namespace StartToBike.Controllers
{
    public class AccountTrainingsController : Controller
    {
        ...
        {
            var trainingAccounts = db.TrainingAccounts.Include(a => a.Account).Include(a => a.Training);
        ...
        public ActionResult Details(int? id)
        {
            ...
            AccountTraining accountTraining = db.TrainingAccounts.Find(id);
        ...
        public ActionResult Create([Bind(Include = "AccountId,TrainingId")] AccountTraining accountTraining)
        {
            ...
            {
                db.TrainingAccounts.Add(accountTraining);
                db.SaveChanges();
        ...
        {
            AccountTraining accountTraining = db.TrainingAccounts.Find(id);
            db.TrainingAccounts.Remove(accountTraining);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
